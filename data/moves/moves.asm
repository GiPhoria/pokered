...
; Characteristics of each move.
	...
	move PAY_DAY,      PAY_DAY_EFFECT,              55, NORMAL,       100, 20
	...
	move HEADBUTT,     FLINCH_SIDE_EFFECT2,         60, NORMAL,       100, 15
	move HORN_ATTACK,  NO_ADDITIONAL_EFFECT,        65, NORMAL,       100, 25
	move FURY_ATTACK,  TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,        90, 20
	...
	move PECK,         NO_ADDITIONAL_EFFECT,        45, FLYING,       100, 35
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,        90, FLYING,       100, 20
	move SUBMISSION,   RECOIL_EFFECT,              100, FIGHTING,      95, 25
	...
	move SLEEP_POWDER, SLEEP_EFFECT,                 0, GRASS,         70, 15
	...
	move NIGHT_SHADE,  NO_ADDITIONAL_EFFECT,       100, GHOST,        100, 15
	...
	move SELFDESTRUCT, EXPLODE_EFFECT,             160, NORMAL,       100,  5
	...
	move SKULL_BASH,   CHARGE_EFFECT,              100, DRAGON,       100, 15
	...
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           105, FIGHTING,      90, 20
	move GLARE,        PARALYZE_EFFECT,              0, NORMAL,       100, 30
	move DREAM_EATER,  DREAM_EATER_EFFECT,         120, PSYCHIC_TYPE, 100, 15
	move POISON_GAS,   POISON_EFFECT,                0, POISON,       100, 20
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  18, NORMAL,        90, 20
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             80, BUG,          100, 15
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, NORMAL,        75, 10
	move SKY_ATTACK,   CHARGE_EFFECT,              140, FLYING,        95,  5
	...
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         50, GROUND,        95, 10
	move REST,         HEAL_EFFECT,                  0, PSYCHIC_TYPE, 100, 10
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT1,        100, ROCK,          95, 10
