...
CeruleanMartClerkText::
	script_mart POKE_BALL, POTION, SUPER_POTION, REPEL, ANTIDOTE, AWAKENING, PARLYZ_HEAL, WATER_STONE

UnusedBikeShopClerkText:: ; unreferenced
	script_mart BICYCLE

VermilionMartClerkText::
	script_mart POKE_BALL, SUPER_POTION, AWAKENING, PARLYZ_HEAL, REPEL, THUNDER_STONE
...
FuchsiaMartClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, SUPER_POTION, REVIVE, FULL_HEAL, SUPER_REPEL, LEAF_STONE

UnusedMartClerkText:: ; unreferenced
	script_mart GREAT_BALL, HYPER_POTION, SUPER_POTION, FULL_HEAL, REVIVE

CinnabarMartClerkText::
	script_mart ULTRA_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, FIRE_STONE

SaffronMartClerkText::
	script_mart GREAT_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, X_SPECIAL, GUARD_SPEC

IndigoPlateauLobbyClerkText::
	script_mart ULTRA_BALL, FULL_RESTORE, MAX_POTION, FULL_HEAL, MAX_REVIVE, MAX_REPEL

SaffronMartClerkChampionText::
	script_mart MASTER_BALL, GREAT_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE

IndigoPlateauLobbyClerkChampionText::
	script_mart ULTRA_BALL, FULL_RESTORE, MAX_POTION, FULL_HEAL, MAX_REVIVE, MAX_REPEL, MAX_ETHER, MAX_ELIXER, PP_UP

CeladonMart2FClerk2ChampionText::
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_RAZOR_WIND, TM_HORN_DRILL, TM_EGG_BOMB, TM_MEGA_PUNCH, TM_MEGA_KICK, TM_TAKE_DOWN, TM_SUBMISSION