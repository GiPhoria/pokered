...
KogaData:
	db $FF, 38, WEEZING, 39, MUK, 45, VENOMOTH, 0

BlaineData:
	db $FF, 40, NINETALES, 42, ARCANINE, 42, RAPIDASH, 48, MAGMAR, 0

SabrinaData:
	db $FF, 40, ABRA, 42, KADABRA, 45, ALAKAZAM, 0
