...
BugCatcherData:
; Viridian Forest
	db 6, WEEDLE, CATERPIE, CATERPIE, CATERPIE, METAPOD, 0
	db 8, WEEDLE, KAKUNA, BEEDRILL, 0
	db 10, BUTTERFREE, BEEDRILL, 0
; Route 3
...
; Rock Tunnel B1F
	db 20, SLOWPOKE, SLOWPOKE, SQUIRTLE, 0
...
; Cerulean City
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 20, WARTORTLE, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 20, IVYSAUR, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 20, CHARMELEON, 0
...
; Viridian Gym
	db $FF, 50, DUGTRIO, 53, PERSIAN, 53, NIDOQUEEN, 54, NIDOKING, 55, RHYDON, 0
...
BrunoData:
	db $FF, 55, PRIMEAPE, 55, HITMONCHAN, 55, HITMONLEE, 58, ONIX, 60, MACHAMP, 0

BrockData:
	db $FF, 12, GEODUDE, 15, ONIX, 0

MistyData:
	db $FF, 20, STARYU, 25, STARMIE, 0
...
KogaData:
	db $FF, 39, WEEZING, 38, MUK, 40, VENOMOTH, 0

BlaineData:
	db $FF, 45, NINETALES, 42, RAPIDASH, 48, ARCANINE, 50, MAGMAR, 0

SabrinaData:
	db $FF, 41, ABRA, 42, KADABRA, 45, ALAKAZAM, 0
...
Green3Data:
	db $FF, 61, PIDGEOT, 61, ALAKAZAM, 61, RHYDON, 61, ARCANINE, 63, EXEGGUTOR, 65, BLASTOISE, 0
	db $FF, 61, PIDGEOT, 61, ALAKAZAM, 61, RHYDON, 61, GYARADOS, 63, ARCANINE, 65, VENUSAUR, 0
	db $FF, 61, PIDGEOT, 61, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, GYARADOS, 65, CHARIZARD, 0

LoreleiData:
	db $FF, 54, DEWGONG, 53, CLOYSTER, 55, SLOWBRO, 58, JYNX, 60, LAPRAS, 0
...
AgathaData:
	db $FF, 55, GASTLY, 58, GOLBAT, 58, HAUNTER, 58, ARBOK, 60, GENGAR, 0

LanceData:
	db $FF, 60, DRATINI, 60, DRAGONAIR, 60, AERODACTYL, 60, GYARADOS, 62, DRAGONITE, 0
